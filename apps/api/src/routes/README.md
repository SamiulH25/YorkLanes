...
| `finance.ts` | `GET /api/finance`, `/api/finance/entries`, `PATCH /api/finance/entries/:entryId`, `/api/finance/monthly-summary`, `/api/finance/budget/:month` | Taziz — [docs/tasks/finance.md](../../../docs/tasks/finance.md) |
